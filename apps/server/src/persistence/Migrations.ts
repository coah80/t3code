...
import Migration0024 from "./Migrations/024_ScheduledTasks.ts";
import Migration0025 from "./Migrations/025_ProjectIcons.ts";
...
export const migrationEntries = [
  ...
  [24, "ScheduledTasks", Migration0024],
  [25, "ProjectIcons", Migration0025],
] as const;
